...
namespace Job.Infrastructure.Migrations
{
    ...
    [Migration("20250701113806_New-Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Job.Core.Entitys.CompanyEntity", b =>
                {
            ...
            modelBuilder.Entity("Job.Core.Entitys.EmployeesEntity", b =>
                {
                    b.Property<string>("UserID")
                        .HasMaxLength(450)
                        .HasColumnType("NVARCHAR(450)");
            ...
            modelBuilder.Entity("Job.Core.Entitys.CompanyEntity", b =>
                {
                    b.HasOne("Employment.Infrastructure.Entitys.AppUser", "AppUser")
                        .WithOne("Company")
                        .HasForeignKey("Job.Core.Entitys.CompanyEntity", "UserID")
            ...
            modelBuilder.Entity("Job.Core.Entitys.EmployeesEntity", b =>
                {
                    b.HasOne("Employment.Infrastructure.Entitys.AppUser", "AppUser")
                        .WithOne("Employees")
                        .HasForeignKey("Job.Core.Entitys.EmployeesEntity", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
